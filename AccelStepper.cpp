...
boolean AccelStepper::runSpeed()
{
    ...
    if (!_stepInterval) //el _stepInterval maneja la velocidad
	    return false;
...
void AccelStepper::setOutputPins(uint8_t mask)
{
	...
	numpins = 3;
    uint8_t i;
    //Serial.print("numpins:");    Serial.println(numpins);
    // siempre es 2
    ///Serial.println("setOutputPins:"); 
    for (i = 0; i < numpins; i++)
    {
      /*Serial.print("mask:");
      Serial.print(mask & (1 << i));
      Serial.print(" pin:");
      Serial.print(_pin[i]);
      Serial.println((mask & (1 << i)) ? (HIGH ^ _pinInverted[i]) : (LOW ^ _pinInverted[i]));*/
